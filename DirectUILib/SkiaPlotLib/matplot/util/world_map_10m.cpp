...
namespace matplot {
	...
	std::pair<std::vector<double>, std::vector<double>> prepare_world_map_10m() {
    ...
    std::pair<std::vector<double>, std::vector<double>>& world_map_10m() {
        static std::pair<std::vector<double>, std::vector<double>> world_map_10m_ = prepare_world_map_10m();
        return world_map_10m_;
    }
#else
    std::pair<std::vector<double>, std::vector<double>>& world_map_10m() {
