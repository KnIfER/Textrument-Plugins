...
public:
    ...
    void RePaint() 
    {
        ...
        CRenderEngine::DrawImageInfo(hDcBackground, &m_pm, rcClient, rcClient, &m_di);
...
class CMenuWndX : public CWindowWnd, public INotifyUI
{
public:
    CMenuWndX() : m_pOwner(NULL), m_pShadowWnd(NULL) { };
